...
if __name__ == '__main__':
	if parse_inputs():
		...
		for a_or_b in ['A', 'B']:
			...
			print("\nFiles containing laughter in training data: %d" % (count_transcription_files_with_laughter_in_corpus(train_folders, a_or_b)))
			...
			print("Files containing laughter in test data: %d \n" % (count_transcription_files_with_laughter_in_corpus(test_folders, a_or_b)))
			...
			print("\nTraining on %d dialogues" % len(train_audio_files))
